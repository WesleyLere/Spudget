    ...
    return (
        <section className='sm:w-auto xl:w-auto'>
            ...
            <div className=' xl:p-20 xl:h-screen sm:p-5 xl:bg-gradient-to-t from-lime-600 to-lime-500 xl:flex xl:flex-row xl:items-center xl:justify-center'>
                ...
                <div className="xl:w-full xl:h-full xl:object-cover xl:bg-slate-300 sm:bg-slate-600 rounded-3xl xl:border-4 xl:border-lime-500 xl:m-5 xl:p-5 sm:m-1 sm:p-1 hover:drop-shadow-xl hover:scale-[1.04] transition ease-out duration-300 sm:flex sm:flex-col sm:items-center xl:mx-auto xl:max-w-6xl">
                ...
                <div className="xl:w-full xl:h-full xl:object-cover xl:bg-slate-300 sm:bg-slate-500 rounded-3xl xl:border-4 xl:border-lime-500 xl:m-5 xl:p-5 sm:m-1 sm:p-1 hover:drop-shadow-xl hover:scale-[1.04] transition ease-out duration-300 sm:flex sm:flex-col sm:items-center xl:mx-auto xl:max-w-6xl">
                ...
                <div className="xl:w-full xl:h-full xl:object-cover xl:bg-slate-300 sm:bg-slate-400 rounded-3xl xl:border-4 xl:border-lime-500 xl:m-5 xl:p-16 sm:m-1 sm:p-1 hover:drop-shadow-xl hover:scale-[1.04] transition ease-out duration-300 sm:flex sm:flex-col sm:items-center xl:mx-auto xl:max-w-6xl">
                ...
                <div className="xl:w-full xl:h-full xl:object-cover xl:bg-slate-300 sm:bg-slate-400 rounded-3xl xl:border-4 xl:border-lime-500 xl:m-5 xl:p-5 sm:m-1 sm:p-1 hover:drop-shadow-xl hover:scale-[1.04] transition ease-out duration-300 sm:flex sm:flex-col sm:items-center xl:mx-auto xl:max-w-6xl">
                ...
                <section className='text-2xl bg-gradient-to-b from-lime-600 to-lime-500'>
                    <div className='xl:flex xl:flex-row xl:justify-evenly'>
                        <div className='flex justify-center'>
                            <img className='p-5 m-5' src='logo.png'></img>
                        </div>
