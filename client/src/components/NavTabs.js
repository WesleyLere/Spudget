...
function NavTabs({ tab, handlePageChange }) {
  return (
    <div className="xl:sticky xl:top-1 xl:z-50 bg-lime-600 flex flex-row justify-center hover:shadow-inner rounded-3xl xl:m-5 sm:m-3 text-xl font-semibold sm:flex sm:flex-col sm:items-center">
