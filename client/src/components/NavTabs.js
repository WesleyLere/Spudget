  ...
  return (
    <div className="xl:sticky xl:top-1 xl:z-50 bg-lime-600 flex flex-row justify-center hover:shadow-inner rounded-3xl xl:m-10 sm:m-3 text-xl font-semibold sm:flex sm:flex-col sm:items-center">
      ...
      <nav className="text-neutral-200 justify-center xl:flex xl:flex-row nav nav-tabs sm:flex sm:flex-col sm:justify-between">
        ...
        <ul className="hover:scale-[1.09] hover:text-amber-400 hover:drop-shadow-lg xl:m-5 sm:m-1 p-5 nav-item">
        ...
        <ul className="hover:scale-[1.2] hover:text-blue-400 hover:drop-shadow-lg xl:m-5 sm:m-1 p-5 nav-item">
          <a href='#signup'
        ...
        <ul className="hover:scale-[1.2] hover:text-emerald-400 hover:drop-shadow-lg text xl:m-5 sm:m-1 p-5 nav-item">
          <a href='#cta'
        ...
        <ul className="hover:scale-[1.2] hover:text-fuchsia-400 hover:drop-shadow-lg xl:m-5 sm:m-1 p-5 nav-item">
          <a href='#moneydash'
        ...
        <ul className='hover:scale-[1.2] hover:text-teal-400 hover:drop-shadow-lg xl:m-5 sm:m-1 p-5 nav-item'>
